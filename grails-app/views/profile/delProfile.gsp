            ...
            <div class="row coralbg white">
                <div class="col-md-6 no-pad">
                    <div class="user-pad">
                        ...
                        <h4 class="white"><i class="fa fa-mail-reply"> </i> <% if(emailId!=null) out.print(emailId) %></h4>
                        <h4 class="white"><i class="fa fa-info-circle"> </i> <% if(bio!=null) out.print(bio) %></h4>
                        <h4 class="white"><i class="fa fa-location-arrow"> </i> <% if(address!=null) out.print(address) %></h4>
                ...
                <div class="col-md-6 no-pad">
                    <div class="user-image">
                        <img class="img-responsive thumbnail" title="<%=fullName%>" alt="<%=fullName%>"
