...
<html>
    ...
    <body>
        ...
        <div id="show-register" class="content scaffold-show" role="main">
            ...
            <f:display bean="register" />
            <g:form resource="${this.register}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.register}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
